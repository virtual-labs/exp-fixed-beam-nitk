...
1. Find logarithmic decrement (δ) from displacement v/s time graph. The logarithmic decrement is defined as follows.  
   [<img src="./images/proc2.png" width="145" height="60" />](./images/proc2.png)
...
2. Find the damping ratio (ζ) from the logarithmic decrement (δ). The damping ratio is given b.  
   [<img src="./images/proc5.png" width="150" height="60" />](./images/proc5.png)  
...
5. Find equivalent mass (m<sub>eq</sub>) kg from ω<sub>n</sub> and k.  
   [<img src="./images/proc11.png" width="100" height="60" />](./images/proc11.png)  
    [<img src="./images/proc12.png" width="800" height="600" />](./images/proc12.png)

6. Find critical damping (c<sub>c</sub>) Ns/m from m<sub>eq</sub> and k.  
